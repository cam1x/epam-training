...
public class TrainArray {
    ...
    public void setArrOfTrains(Train[] array) {
        if (array != null) {
            ...
            System.arraycopy(array, 0, arrOfTrains, 0, array.length);
        }
    }
    ...
    public void printInfoByNumber(int number) {
        for (Train arrOfTrain : arrOfTrains) {
            if (arrOfTrain.getTrainNumber() == number) {
                arrOfTrain.print();
            }
        }
    }
    ...
    public void addTrain(Train train) {
        if (train != null) {
            ...
            if (getSize() >= 0) System.arraycopy(arrOfTrains, 0, newTrains, 0, getSize());
    ...
    public String toString() {
        if (arrOfTrains != null) {
            ...
            for (Train train : arrOfTrains) {
                string.append(train.toString()).append("\n");
            }
