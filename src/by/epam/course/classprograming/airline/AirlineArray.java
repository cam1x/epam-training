...
public class AirlineArray {
    ...
    public void setArrayOfAirlines(Airline[] array) {
        if (array != null) {
            ...
            if (getSize() >= 0) System.arraycopy(array, 0, arrayOfAirlines, 0, getSize());
        }
    }
    ...
    */
    ...
    public void addAirline(Airline airline) {
        if (airline != null) {
            ...
            if (getSize() >= 0) System.arraycopy(arrayOfAirlines, 0, newAirlines, 0, getSize());
    ...
    public String toString() {
        if (arrayOfAirlines != null) {
            ...
            for (Airline airline : arrayOfAirlines) {
                string.append(airline.toString()).append("\n");
            }
    ...
    private AirlineArray noMatches() {
