...
public class Student {
    ...
    public String toString() {
        return String.format("%15s %7s %7s %5s %5s %5s %5s %5s", surname, initials, groupNumber,
    ...
    public boolean equals(Object obj) {
        ...
        boolean theSameMarks = Arrays.equals(getMarks(), other.getMarks());
    ...
    public int hashCode() {
        ...
        result = prime * result + Arrays.hashCode(getMarks());
